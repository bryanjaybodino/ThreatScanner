...
namespace ThreatScanner
{
    ...
    public partial class FullScannerForm : Form
    {
        ...
        private static readonly string[] SensitivePaths =
        {
            ...
            // ASP.NET
            // ════════════════════════════════════════════════════════════════════
            "/Elmah.axd", "/elmah.axd", "/trace.axd", "/Trace.axd", "/WebResource.axd", "/ScriptResource.axd", "/web.config", "/web.config.bak", "/web.config.old", "/web.config.orig", "/web.config~", "/Web.config", "/web.Debug.config", "/web.Release.config", "/global.asax", "/Global.asax", "/app.config", "/App.config", "/packages.config", "/applicationHost.config", "/machine.config", "/_mvc", "/_api", "/api/swagger/ui/index", "/swagger/ui/index",
            ...
            // API / SWAGGER / GRAPHQL
            // ════════════════════════════════════════════════════════════════════
            "/api", "/api/", "/api/v1", "/api/v1/", "/api/v2", "/api/v2/", "/api/v3", "/api/v3/", "/api/docs", "/api/docs/", "/api/swagger", "/api/swagger.json", "/api/swagger.yaml", "/api/openapi.json", "/api/openapi.yaml", "/api/spec", "/api/spec.json", "/api/users", "/api/user", "/api/admin", "/api/login", "/api/auth", "/api/health", "/api/status", "/api/version", "/api/config", "/api/debug", "/api/test", "/api/keys", "/api/token", "/api/tokens", "/api/secret", "/api/secrets", "/api/internal", "/api/private", "/swagger", "/swagger/", "/swagger.json", "/swagger.yaml", "/swagger-ui", "/swagger-ui/", "/swagger-ui.html", "/swagger-ui/index.html", "/swagger-resources", "/swagger-resources/configuration/ui", "/swagger-resources/configuration/security", "/openapi.json", "/openapi.yaml", "/openapi.yml", "/v2/api-docs", "/v3/api-docs", "/graphql", "/graphiql", "/graphql/console", "/graphql/playground", "/playground", "/altair", "/voyager",
